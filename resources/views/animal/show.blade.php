        ...
        <div class="w3-container">
		  ...
		  <br>
        	<div class="w3-container w3-center w3-theme-l3" style="max-width: 800px;">
        		...
        		<br><br>
        		<div>
                    <h3><i class="fas fa-comment-medical"></i> Notre sélection de conseils</h3>
                    <ul class="list-group p-4">
                        @if($conseils)
                            @foreach($conseils as $conseil)
                                <a href="{{ url('conseil/' . $conseil->id) }}">
        		...
        		<p class="w3-center">
        			<p><a href="{{ url('animal/'.$animal->id.'/edit') }}" class="w3-button w3-theme-d2 w3-round">Modifier les infos du profil</a></p>
        	...
        	<br><br>
        	<p><a href="{{ url('animal') }}" class="w3-button w3-theme-d2 w3-round"><i class="fa fa-angle-left w3-margin-right"></i>Retour à mes animaux</a></p>
          <br>
        </div>
      </div>
